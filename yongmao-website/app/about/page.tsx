  ...
  if (!company) {
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="text-gray-600">目前沒有公司資料</p>
      </div>
    )
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div className="bg-white rounded-lg shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600">嚴格的品質控制流程，確保每一件產品都符合最高標準</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">創新技術</h3>
            <p className="text-gray-600">持續投入研發，運用最新技術提供創新的橡膠解決方案</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600">經驗豐富的專業團隊，提供全方位的客戶服務與技術支援</p>
          </div>
        </div>
